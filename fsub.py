...
from cinderella import SUDO_USERS as SUDO_USERS
...
@run_async.on_callback_query(static_data_filter)
...
@run_async.on_message(filters.text & ~filters.private & ~filters.edited, group=1)
...
@run_async.on_message(filters.command(["forcesubscribe", "fsub"]) & ~filters.private)
